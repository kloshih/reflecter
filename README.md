...
## <a name="Runtime"></a>Runtime Class
...
- **packages** (Object<string,[Package](#Package)>) 
...
- **modules** (Object<string,[Module](#Module)>)
...
- **locals** (Object<string,[Package](#Package)>)
...
- **dependencies** (Object<string,[Package](#Package)>)
